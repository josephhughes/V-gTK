...
def process_master_alignment(reference_alignment_file, input_dir, output_dir, keep_intermediate_files=False):
    ...
    for ref_id, ref_record in master_alignment.items():
        ...
        subalignment_file = os.path.join(input_dir, f"{ref_id}_aligned.fasta")
...
if __name__ == "__main__":
    ...
    parser.add_argument("-o", "--output_dir", default="merged_subMSA", help="Directory to save padded subalignments and merged files. Default: merged_subMSA.")
